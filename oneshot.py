...
files = [
  client.files.upload(file="Hospital-discharge-combined-scenario-and-example-discharge.pdf"),
]

wait_for_files_active(files)

prompt = """You are a software developer in the NHS. You need to generate a synthetic discharge summary in html format. 
Use the example discharge summary given to generate a synthetic version. 
...
Do not include the PRSB header."""
...
for i in range(0,num_outputs):
    ...
    with open(f"outputs/oneshot/output{i}.html","w") as f:
